...
export function DataTablePagination<TData>({
  ...
  return (
    <div className="flex flex-col-reverse sm:gap-4 gap-3 sm:flex-row sm:items-center sm:justify-between px-2 pb-5">
      <div className="flex-1 text-sm text-muted-foreground">
        {table.getFilteredSelectedRowModel().rows.length} of{' '}
        {table.getFilteredRowModel().rows.length} row(s) selected.
      </div>
      <div className="flex flex-col-reverse sm:gap-4 gap-1 sm:flex-row sm:items-center sm:gap-6 lg:gap-8">
