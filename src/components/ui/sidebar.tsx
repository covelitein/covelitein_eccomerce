...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("h-9 w-9 hover:bg-blue-600/10 bg-blue-600/20 hover:text-blue-600 text-blue-600 text-xl rounded-full", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "box-border overflow-hidden w-full",
